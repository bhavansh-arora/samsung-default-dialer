(self["webpackChunksamsung_default_dialer"] = self["webpackChunksamsung_default_dialer"] || []).push([["common"],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PhoneService": () => (/* binding */ PhoneService)
/* harmony export */ });
...
let PhoneService = class PhoneService {
    constructor(platform) {
        ...
        this.selectedContactBehaviourSubject = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject(null);
        this.currentCallStatusSubject = new rxjs__WEBPACK_IMPORTED_MODULE_1__.Subject();
    ...
    isMicrophoneMuted() {
        return new Promise((resolve, reject) => {
            LyluDialler.isMicrophoneMuted((result) => {
                console.log('(LyluDialler) isMicrophoneMuted');
                console.log(result);
                resolve(result.isMuted);
            }, (error) => {
    ...
    setMicrophone(mode) {
        return new Promise((resolve, reject) => {
            LyluDialler.setMicrophoneMute(mode === 'on', (result) => {
    ...
    initialize() {
        LyluDialler.attachCallingStatusCallback((result) => {
...
PhoneService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
